/*! SKPlayer */ ! function(t, e) {
  "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define &&
    define.amd ? define("skPlayer", [], e) : "object" == typeof exports ? exports.skPlayer = e() : t.skPlayer = e()
}(this, function() {
  return function(t) {
    function e(o) {
    ...
    console.log("%cSKPlayer 3.0.8", "color:#D94240"), n(1);
    var s = {
        ...
        ajax: function(t) {
          ...
          e.onreadystatechange = function() {
            4 === e.readyState && (e.status >= 200 && e.status < 300 ? t.success && t.success(e.responseText) :
              t.fail && t.fail(e.status))
      ...
      l = function() {
        function t(e) {
          ...
          if (this.option = e, !(this.option.music && this.option.music.type && this.option.music.source))
            return console.error("请正确配置对象！"), Object.create(null);
          this.root = this.option.element, this.type = this.option.music.type, this.music = this.option.music.source,
            this.isMobile = /mobile/i.test(window.navigator.userAgent), this.toggle = this.toggle.bind(this),
            this.toggleList = this.toggleList.bind(this), this.toggleMute = this.toggleMute.bind(this), this.switchMode =
            this.switchMode.bind(this), "file" === this.type ? (this.root.innerHTML = this.template(), this.init(),
              this.bind()) : "cloud" === this.type && (this.root.innerHTML =
              '<p class="skPlayer-tip-loading">LOADING</p>', s.ajax({
                url: a + "playlist/detail?id=" + this.music,
                beforeSend: function() {
                  console.log("SKPlayer正在努力的拉取歌单 ...")
                },
                success: function(t) {
                  console.log("歌单拉取成功！"), n.music = JSON.parse(t), n.root.innerHTML = n.template(), n.init(),
                    n.bind()
                },
                fail: function(t) {
        ...
        return r(t, [{
          ...
          value: function() {
            var t = '\n            <audio class="skPlayer-source" src="' + ("file" === this.type ? this
              ...
              ("singleloop" === this.option.mode ? "skPlayer-mode skPlayer-mode-loop" : "skPlayer-mode") +
              '"></i>\n            </div>\n            <ul class="skPlayer-list">\n        ';
            for (var e in this.music) t += '\n                <li data-index="' + e +
              '">\n                    <i class="skPlayer-list-sign"></i>\n                    <span class="skPlayer-list-index">' +
              (parseInt(e) + 1) +
              '</span>\n                    <span class="skPlayer-list-name" title="' + this.music[e].name +
              '">' + this.music[e].name +
              '</span>\n                    <span class="skPlayer-list-author" title="' + this.music[e]
              .author + '">' + this.music[e].author + "</span>\n                </li>\n            ";
            return t += "\n            </ul>\n        "
          }
        }, {
          key: "init",
          value: function() {
            ...
            this.dom = {
              ...
              }, this.audio = this.root.querySelector(".skPlayer-source"), this.option.listshow && (
                this.root.className = "skPlayer-list-on"), "singleloop" === this.option.mode && (this.audio
                .loop = !0), this.dom.musicitem[0].className = "skPlayer-curMusic", "cloud" === this.type &&
              s.ajax({
                ...
                success: function(e) {
                  ...
                  null !== n ? (console.log("歌曲拉取成功！"), t.audio.src = n) : (console.log(
                    "歌曲拉取失败！ 资源无效！"), 1 !== t.music.length && t.next())
                },
                fail: function(t) {
          ...
          value: function() {
            ...
            this.updateLine = function() {
                var e = t.audio.buffered.length ? t.audio.buffered.end(t.audio.buffered.length - 1) / t
                  .audio.duration : 0;
                ...
                t.dom.timeline_played.style.width = s.percentFormat(n), t.dom.timetext_played.innerHTML =
                  s.timeFormat(t.audio.currentTime)
              }), this.audio.addEventListener("seeked", function(e) {
                t.play()
              }), this.audio.addEventListener("ended", function(e) {
                t.next()
              }), this.dom.playbutton.addEventListener("click", this.toggle), this.dom.switchbutton.addEventListener(
                "click", this.toggleList), this.isMobile || this.dom.volumebutton.addEventListener(
                "click", this.toggleMute), this.dom.modebutton.addEventListener("click", this.switchMode),
              this.dom.musiclist.addEventListener("click", function(e) {
                ...
                o = parseInt(n.getAttribute("data-index")), r = parseInt(t.dom.musiclist.querySelector(
                  ".skPlayer-curMusic").getAttribute("data-index")), o === r ? t.play() : t.switchMusic(
                  o + 1)
                ...
                isNaN(t.audio.duration) || (t.dom.timeline_played.style.width = s.percentFormat(o), t
                  .dom.timetext_played.innerHTML = s.timeFormat(o * t.audio.duration), t.audio.currentTime =
                  o * t.audio.duration)
                ...
                t.dom.volumeline_value.style.width = s.percentFormat(o), t.audio.volume = o, t.audio.muted &&
                  t.toggleMute()
              })
          }
        }, {
          key: "prev",
          value: function() {
            var t = parseInt(this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute(
              "data-index"));
            0 === t ? 1 === this.music.length ? this.play() : this.switchMusic(this.music.length - 1 +
              1) : this.switchMusic(t - 1 + 1)
          }
        }, {
          key: "next",
          value: function() {
            var t = parseInt(this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute(
              "data-index"));
            t === this.music.length - 1 ? 1 === this.music.length ? this.play() : this.switchMusic(1) :
              this.switchMusic(t + 1 + 1)
          }
        }, {
          key: "switchMusic",
          value: function(t) {
            var e = this;
            return "number" != typeof t ? void console.error("请输入正确的歌曲序号！") : (t -= 1) < 0 || t >= this
              .music.length ? void console.error("请输入正确的歌曲序号！") : t == this.dom.musiclist.querySelector(
                ".skPlayer-curMusic").getAttribute("data-index") ? void this.play() : (this.dom.musiclist
                .querySelector(".skPlayer-curMusic").classList.remove("skPlayer-curMusic"), this.dom.musicitem[
                  t].classList.add("skPlayer-curMusic"), this.dom.name.innerHTML = this.music[t].name,
                this.dom.author.innerHTML = this.music[t].author, this.dom.cover.src = this.music[t].cover,
                void("file" === this.type ? (this.audio.src = this.music[t].src, this.play()) : "cloud" ===
                  this.type && s.ajax({
                    ...
                    success: function(t) {
                      ...
                      null !== n ? (console.log("歌曲拉取成功！"), e.audio.src = n, e.play()) : (console.log(
                        "歌曲拉取失败！ 资源无效！"), 1 !== e.music.length && e.next())
                    },
                    fail: function(t) {
                      console.error("歌曲拉取失败！ 错误码：" + t)
                    }
          ...
          key: "play",
          value: function() {
            this.audio.paused && (this.audio.play(), this.dom.playbutton.classList.add("skPlayer-pause"),
              this.dom.cover.classList.add("skPlayer-pause"))
          }
        }, {
          key: "pause",
          value: function() {
            this.audio.paused || (this.audio.pause(), this.dom.playbutton.classList.remove(
              "skPlayer-pause"), this.dom.cover.classList.remove("skPlayer-pause"))
          }
        }, {
          key: "toggle",
          value: function() {
          ...
          key: "toggleList",
          value: function() {
            this.root.classList.contains("skPlayer-list-on") ? this.root.classList.remove(
              "skPlayer-list-on") : this.root.classList.add("skPlayer-list-on")
          }
        }, {
          key: "toggleMute",
          value: function() {
            this.audio.muted ? (this.audio.muted = !1, this.dom.volumebutton.classList.remove(
              "skPlayer-quiet"), this.dom.volumeline_value.style.width = s.percentFormat(this.audio
              .volume)) : (this.audio.muted = !0, this.dom.volumebutton.classList.add(
              "skPlayer-quiet"), this.dom.volumeline_value.style.width = "0%")
          }
        }, {
          key: "switchMode",
          value: function() {
            this.audio.loop ? (this.audio.loop = !1, this.dom.modebutton.classList.remove(
              "skPlayer-mode-loop")) : (this.audio.loop = !0, this.dom.modebutton.classList.add(
              "skPlayer-mode-loop"))
          }
        }, {
          key: "destroy",
    ...
    t.exports = function(t) {
      ...
      return e.toString = function() {
        ...
        for (r = 0; r < t.length; r++) {
          var i = t[r];
          "number" == typeof i[0] && o[i[0]] || (n && !i[2] ? i[2] = n : n && (i[2] = "(" + i[2] +
            ") and (" + n + ")"), e.push(i))
        }
      }, e
    }
    ...
    function s(t, e) {
      ...
      var o = P[P.length - 1];
      if ("top" === t.insertAt) o ? o.nextSibling ? n.insertBefore(e, o.nextSibling) : n.appendChild(e) : n.insertBefore(
        e, n.firstChild), P.push(e);
      else {
    ...
    function u(t, e) {
      ...
      } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" ==
        typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = l(e), o = h
    ...
    t.exports = function(t, e) {
      ...
      e = e || {}, e.attrs = "object" == typeof e.attrs ? e.attrs : {}, e.singleton || (e.singleton = f()), e
        .insertInto || (e.insertInto = "head"), e.insertAt || (e.insertAt = "bottom");
      var n = r(t, e);
      return o(n, e),
        function(t) {
    ...
    t.exports = function(t) {
      ...
      return t.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(t, e) {
        ...
        var s;
        return s = 0 === r.indexOf("//") ? r : 0 === r.indexOf("/") ? n + r : o + r.replace(/^\.\//, ""),
